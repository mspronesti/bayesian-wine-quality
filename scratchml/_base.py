...
class Regressor(Estimator, ABC):
    ...
    def score(self, X, y_true):
        """
        Retrieves a score for the regressor
        model expressed as R^2 score
        ...
        mse_avg = mean_squared_error(y_true, np.mean(y_true, axis=0))
        # for more see the definition of r2_score
        return 1 - mse / mse_avg
